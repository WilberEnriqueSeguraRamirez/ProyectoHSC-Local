...
namespace MantenimientosContaJNLD
{
    ...
    {/*Jaime Noel López Daniel 0901-18-735*/
        ...
        public mantenimientoTipoOperacion()
        {
            ...
            navegador1.funAsignarAliasVista(alias, "tipooperacion", "hotelSanCarlos");
            ...
            navegador1.idAplicacion = "7703";//en la nueva se usara el nombre
            ...
            navegador1.pideGrid(this.dgvOperacion);
            //llena el data grid
        ...
        private void dgvOperacion_SelectionChanged(object sender, EventArgs e)
        {
            navegador1.funSeleccionarDTVista(dgvOperacion);
        }
